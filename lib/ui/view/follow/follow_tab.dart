...
class FollowTab extends StatefulHookConsumerWidget {
  const FollowTab({super.key, required this.profileId});
  final String profileId;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _FollowTabState();
}
...
class _FollowTabState extends ConsumerState<FollowTab>
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      final newItems =
          await ref.read(profileRepositoryProvider).getFollowingWithpagination(
                widget.profileId,
                pageKey,
                _pageSize + pageKey,
              );
