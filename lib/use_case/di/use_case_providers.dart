...
import 'package:share_study_app/use_case/get_my_activity_use_case.dart';
...
final getMyActivityUseCaseProvider = Provider<GetMyActivityUseCase>((ref) {
  return GetMyActivityUseCase(
