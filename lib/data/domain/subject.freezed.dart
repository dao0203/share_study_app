...
abstract class $SubjectCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String course});
}
...
class _$_Subject implements _Subject {
  const _$_Subject({this.id = "", this.name = "", this.course = ""});
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, course);
...
abstract class _Subject implements Subject {
  const factory _Subject(
      {final String id, final String name, final String course}) = _$_Subject;
